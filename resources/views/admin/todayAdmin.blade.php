    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="{{ route('adminDashboard') }}">All Appointments</a></li>
            </ul>
                                ...
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $appointments = Reservation::where('speciality', 'General practice')
                                ...
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $appointments = Reservation::where('speciality', 'Pediatrics')
                                            ->whereDate('appointment_date',date("Y-m-d"))->get();
                                ...
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $appointments = Reservation::where('speciality', 'Radiology')
                                            ->whereDate('appointment_date',date("Y-m-d"))->get();
                                ...
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $appointments = Reservation::where('speciality', 'Ophthalmology')
                                            ->whereDate('appointment_date',date("Y-m-d"))->get();
                                ...
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $appointments = Reservation::where('speciality', 'Sports medicine and rehabilitation')
                                            ->whereDate('appointment_date',date("Y-m-d"))->get();
                                ...
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $appointments = Reservation::where('speciality', 'Oncology')
                                            ->whereDate('appointment_date',date("Y-m-d"))->get();
                                ...
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $appointments = Reservation::where('speciality', 'Dermatology')
                                            ->whereDate('appointment_date',date("Y-m-d"))->get();
                                ...
                                <div class="col-lg-8 details order-2 order-lg-1">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $appointments = Reservation::where('speciality', 'Emergency Medicine')
                                            ->whereDate('appointment_date',date("Y-m-d"))->get();
